...
declare namespace AFrame {
  ...
  export interface Entity extends ANode {
    ...
    addEventListener(
      type: "child-attached",
      listener: DetailEventHandler<{ el: Element | Entity }>,
      useCapture?: boolean
    ): void;
    addEventListener(
      type: "componentchanged",
      listener: DetailEventHandler<{ name: string }>,
      useCapture?: boolean
    ): void;
    addEventListener(
      type: "componentremoved",
      listener: DetailEventHandler<{
        name: string;
        id: string;
        newData: any;
        oldData: any;
    ...
    addEventListener(
      name: "stateadded",
      handler: DetailEventHandler<{ state: string }>,
      useCapture?: boolean
    ): void;
    addEventListener(
      name: "stateremoved",
    ...
    addEventListener(
      name: "schemachanged",
      handler: DetailEventHandler<{ componentName: string }>,
      useCapture?: boolean
    ): void;
  }
