    ...
    return (
      (() => {
        ...
        class i {
          constructor(e, i, o = {}) {
            (this._scene = e),
              ...
              (this.initialPositionAsOrigin = o.initialPositionAsOrigin || !1);
          }
          setProjection(t) {
            this._proj = t;
          }
          ...
          _haversineDist(t, i) {
            const o = e.MathUtils.degToRad(i.longitude - t.longitude),
              n = e.MathUtils.degToRad(i.latitude - t.latitude),
              s =
                Math.sin(n / 2) * Math.sin(n / 2) +
                Math.cos(e.MathUtils.degToRad(t.latitude)) *
                  Math.cos(e.MathUtils.degToRad(i.latitude)) *
        ...
        class s {
          constructor(t, i) {
            ...
            if (
              ...
              (this.cameraWebcam = new e.OrthographicCamera(
                -0.5,
                0.5,
                0.5,
                -0.5,
        ...
        const r = new e.Vector3(0, 0, 1),
          a = new e.Euler(),
          h = new e.Quaternion(),
          c = new e.Quaternion(-Math.sqrt(0.5), 0, 0, Math.sqrt(0.5)),
          d = { type: "change" };
          ...
          constructor(t) {
            ...
            (this.connect = function () {
              ...
              (this.update = function () {
                ...
                if (t) {
                  let n = t.alpha
                      ? e.MathUtils.degToRad(t.alpha) + i.alphaOffset
                      : 0,
                    s = t.beta ? e.MathUtils.degToRad(t.beta) : 0,
                    l = t.gamma ? e.MathUtils.degToRad(t.gamma) : 0;
                  const u = i.screenOrientation
                    ? e.MathUtils.degToRad(i.screenOrientation)
                    : 0;
                  ...
                  !(function (t, e, i, o, n) {
                    ...
                    i.object.quaternion,
                    n,
                    this.smoothingFactor < 1 ? s - Math.PI : s,
                    this.smoothingFactor < 1 ? l - this.HALF_PI : l,
                    u
                  ),
                    8 * (1 - o.dot(i.object.quaternion)) > 1e-6 &&
                      (o.copy(i.object.quaternion), i.dispatchEvent(d));
                }
              }),
